...
// function that resturns a ramadon lowercase letter using a random index in the 'letters' string
...
function generatePassword(lower, upper, number, symbol, length){
    ...
    // Checking if the value for index of 1 in each item (AKA Array) in the the typesArr array is true or false. Also, removing the item from the typesArr array if it is false.
